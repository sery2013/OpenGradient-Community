...
function renderTable() {
  ...
  pageData.forEach(stats => {
    ...
    shareBtn.innerHTML = `<svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor" style="display: block;"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.244 2.25H8.05l4.713 6.231zm-1.161 17.52h1.833L7.08 4.126H5.03z"/></svg>`;
    ...
    shareBtn.title = shareBtnTitle;
    
    shareBtn.onclick = function(e) {
        e.stopPropagation();
        shareUserOnTwitter(name);
    };
